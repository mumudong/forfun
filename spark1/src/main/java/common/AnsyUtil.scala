...
import org.ansj.splitWord.analysis.{IndexAnalysis, NlpAnalysis, ToAnalysis}
...
//        UserDefineLibrary.insertWord("恒昌财富", "userDefine", 1000)
    ...
    def testDic():Unit={
        ...
        UserDefineLibrary.insertWord("中华", "userDefine", 1000)
        UserDefineLibrary.insertWord("中华人民", "userDefine", 1000)
        UserDefineLibrary.insertWord("华人", "userDefine", 1000)
        UserDefineLibrary.insertWord("人民", "userDefine", 1000)
        println("IndexAnalysis -->" + IndexAnalysis.parse("中华人民太多了"))
        println("ToAnalysis-->" + ToAnalysis.parse("中华人民太多了"))
        println("NlpAnalysis-->" + NlpAnalysis.parse("中华人民太多了"))
