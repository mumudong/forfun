...
//    mode match {
//      case SaveMode.Update => val duplicateSetting = rddSchema.fields.map(f => dialect.quoteIdentifier(f.name)).map(name => s"$name=?").mkString(",")
...
//    case IntegerType =>
//      (stmt: PreparedStatement, row: Row, pos: Int,valueIndex: Int) =>
//        stmt.setInt(pos + 1, row.getInt(valueIndex))
//
//    case LongType =>
//      (stmt: PreparedStatement, row: Row, pos: Int,valueIndex: Int) =>
//        stmt.setLong(pos + 1, row.getLong(valueIndex))
//
//    case DoubleType =>
//      (stmt: PreparedStatement, row: Row, pos: Int,valueIndex: Int) =>
//        stmt.setDouble(pos + 1, row.getDouble(valueIndex))
//
//    case FloatType =>
//      (stmt: PreparedStatement, row: Row, pos: Int,valueIndex: Int) =>
//        stmt.setFloat(pos + 1, row.getFloat(valueIndex))
//
//    case ShortType =>
//      (stmt: PreparedStatement, row: Row, pos: Int,valueIndex: Int) =>
//        stmt.setInt(pos + 1, row.getShort(valueIndex))
//
//    case ByteType =>
//      (stmt: PreparedStatement, row: Row, pos: Int,valueIndex: Int) =>
//        stmt.setInt(pos + 1, row.getByte(valueIndex))
//
//    case BooleanType =>
//      (stmt: PreparedStatement, row: Row, pos: Int,valueIndex: Int) =>
//        stmt.setBoolean(pos + 1, row.getBoolean(valueIndex))
//
//    case StringType =>
//      (stmt: PreparedStatement, row: Row, pos: Int,valueIndex: Int) =>
//        stmt.setString(pos + 1, row.getString(valueIndex))
//
//    case BinaryType =>
//      (stmt: PreparedStatement, row: Row, pos: Int,valueIndex: Int) =>
//        stmt.setBytes(pos + 1, row.getAs[Array[Byte]](valueIndex))
//
//    case TimestampType =>
//      (stmt: PreparedStatement, row: Row, pos: Int,valueIndex: Int) =>
//        stmt.setTimestamp(pos + 1, row.getAs[java.sql.Timestamp](valueIndex))
//
//    case DateType =>
//      (stmt: PreparedStatement, row: Row, pos: Int,valueIndex: Int) =>
//        stmt.setDate(pos + 1, row.getAs[java.sql.Date](valueIndex))
//
//    case t: DecimalType =>
//      (stmt: PreparedStatement, row: Row, pos: Int,valueIndex: Int) =>
//        stmt.setBigDecimal(pos + 1, row.getDecimal(valueIndex))
//
//    case ArrayType(et, _) =>
...
//          typeName,
//          row.getSeq[AnyRef](valueIndex).toArray)
//        stmt.setArray(pos + 1, array)
//
//    case _ =>
//      (_: PreparedStatement, _: Row, pos: Int,valueIndex: Int) =>
...
//      val numFields = if(update) rddSchema.fields.length * 2 else rddSchema.fields.length
//
//      try {
//        var rowCount = 0
...
//                }
//              }else{
//                if (row.isNullAt(i - numFields / 2)) {
//                  stmt.setNull(i + 1, nullTypes(i - numFields / 2))
//                } else {
//                  setters(i - numFields / 2).apply(stmt, row, i,i - numFields / 2)
//                }
//              }
//            }else{
//              if (row.isNullAt(i)) {
