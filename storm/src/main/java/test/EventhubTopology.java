...
import test.bolt.EventhubBoltTwo;
 ...
 *
 * 注意------------->
 * 1,该项目打包后需要修改Meta-inf/service下Export文件，添加其所有实现类
 * 2,修改storm-eventhub包下org.apache.storm.eventhubs.spout.SimplePartitionManager类，zookeeper路径中namespace后的斜杠删除
 *
...
//                "zk1-tianxi.vymdbanfbsrujcdydkzzsswlcg.ax.internal.chinacloudapp.cn:2181,zk4-tianxi.vymdbanfbsrujcdydkzzsswlcg.ax.internal.chinacloudapp.cn:2181"
        ...
        builder.setSpout("RandomSentence", new EventHubSpout(spoutConfig), 4);
        builder.setBolt("antifraud", new EventhubBoltTwo(), 2).shuffleGrouping("RandomSentence");//.setNumTasks(10);

        Config config = new Config();
        config.setDebug(false);
        config.setMessageTimeoutSecs(60 * 60);
