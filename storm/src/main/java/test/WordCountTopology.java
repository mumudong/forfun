package test;//package com.dscn.helloworld;



import test.bolt.WordCountBolt;
import test.bolt.WordNormalizerBolt;
import test.common.Constants;
import test.utilities.CommonUtil;
...
//        builder.setBolt("SurfBolt", new SurfBolt(), 20).shuffleGrouping("RandomSentence");
        ...
        builder.setBolt("WordCount", new WordCountBolt(), 1).fieldsGrouping("WordNormalizer", new Fields("JsonMsg")).setNumTasks(1);
