...
public class HelloWorldClientFactory extends BasePooledObjectFactory<HelloWorldClient> {
    ...
    public HelloWorldClient create() throws Exception {
        return new HelloWorldClient("127.0.0.1",50051);
    }
    ...
    public static void main(String[] args) {
        ...
        /** 连接池创建 */
        final GenericObjectPool<HelloWorldClient> objectPool = new GenericObjectPool<HelloWorldClient>(new HelloWorldClientFactory(), poolConfig);
    ...
    private static Runnable makeTask(final GenericObjectPool<HelloWorldClient> objectPool){
        return new Runnable() {
            public void run() {
