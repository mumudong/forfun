...
public class KryoSerialiseUtil {
    private static Logger logger = LoggerFactory.getLogger(KryoSerialiseUtil.class);
    ...
    static{
        kryo_pool = new KryoPool.Builder(new KryoFactory(){
            public Kryo create() {
                Kryo kryo = new Kryo();
                return kryo;
            }
