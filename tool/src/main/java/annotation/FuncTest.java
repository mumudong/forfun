...
public class FuncTest {
    public static void main(String[] args) {
        Set<Class<?>> annotationedClasses = AnnotationScanner.getAnnotationClassByReflection("annotation", FuncAnnotation.class);
        ...
        Set<Method> annotationMethods = AnnotationScanner.getAnnotationMethodByReflection("annotation", FuncAnnotation.class);
