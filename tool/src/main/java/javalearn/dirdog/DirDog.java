...
public class DirDog {
     ...
     * @throws Exception
     */
    public DirDog(File file, boolean subDir, FileActionCallback callback) throws Exception {
        if (!file.isDirectory())
...
class DogWatch {
    public static void main(String[] args) throws Exception {
        final File file = new File("D:\\javalearn.dirdog");
        new Thread(new Runnable() {
            @Override
            public void run() {
                try {
                    new DirDog(file, true, new FileActionCallback() {
                        @Override
